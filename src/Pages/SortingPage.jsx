    ...
    <React.Fragment>
      ...
      <Container className='sortingPage'>
        <div className='row'>
          ...
          <div className="row">
            <div className="col-8">
              <div className='algorithm_description'>
                {description}
              </div>
            </div>
            <div className="col-4">
              <h3 style={{marginBottom: '2rem'}}>Agenda</h3>
              <ColorDescription color={iteratorColor} meaning={currentMeaning.iteratorColor}/>
              <ColorDescription color={curColor} meaning={currentMeaning.curColor}/>
              <ColorDescription color={maxElementColor} meaning={currentMeaning.maxElementColor}/>
              <hr />
              <br />
              <div className='row'>
                <div className="col-8">
